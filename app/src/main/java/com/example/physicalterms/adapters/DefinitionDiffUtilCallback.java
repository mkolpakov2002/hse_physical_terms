...
public class DefinitionDiffUtilCallback extends DiffUtil.Callback{

    private List<DefinitionRow> oldList;
    private List<DefinitionRow> newList;

    public DefinitionDiffUtilCallback(List<DefinitionRow> oldList, List<DefinitionRow> newList) {
        this.oldList = oldList;
        this.newList = newList;
    }

    public DefinitionDiffUtilCallback() {
    }
